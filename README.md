...
First i wrote a C++ version of the game that can be easily played in terminal.
Steps:
...
Then i decided to make a web version of the game using JavaScript, HTML, and CSS. The web version provides a more interactive and visually appealing experience for players.
